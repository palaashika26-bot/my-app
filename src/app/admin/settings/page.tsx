...
export default function AdminSettingsPage() {
  ...
  const [general, setGeneral] = useState({ platform: 'EliosWholesale', supportEmail: 'support@elioswholesale.in', supportPhone: '+91 22 4567 8900', exchangeRate: '12.00', serviceFee: '8', invoicePrefix: 'BK-ORD-', requestPrefix: 'BK-REQ-' });
      ...
      <div className="bg-card rounded-xl border border-border shadow-card p-5">
        {tab === 'general' && (
          <div className="space-y-3 max-w-2xl">
            ...
            {([
              ['Platform Name','platform'],['Support Email','supportEmail'],['Support Phone','supportPhone'],['Exchange Rate (1 CNY = INR)','exchangeRate'],['Service Fee %','serviceFee'],['Invoice Prefix','invoicePrefix'],['Request Prefix','requestPrefix']
            ] as const).map(([lbl, k]) => (
