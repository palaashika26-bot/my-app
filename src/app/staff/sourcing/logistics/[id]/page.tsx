...
export default function StaffLogisticsDetailPage() {
  ...
  return (
    <div>
      <Link href="/staff/sourcing/logistics" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground mb-4"><ArrowLeft className="w-4 h-4" /> Back to Logistics</Link>
