          ...
          <div className="bg-card rounded-xl border border-border shadow-card p-5">
            ...
            {proofDataUrl ? (
              ...
              <div
                ...
                className="border-2 border-dashed border-border rounded-xl p-8 flex flex-col items-center gap-2 cursor-pointer hover:border-[#4A3B52]/50 hover:bg-[#4A3B52]/10 transition-colors"
              >
